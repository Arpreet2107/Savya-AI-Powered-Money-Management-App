...
import in.Arpreet.Savya.entity.ExpenseEntity;
...
public interface ExpenseRepository extends JpaRepository<ExpenseEntity, Long> {
    ...
    @Query("SELECT SUM(e.amount) FROM ExpenseEntity e WHERE e.profile.id = :profileId")// if the issue persists, then change i to e(Fix the alias and @Param in your custom JPQL query so there are no symbol errors.)
